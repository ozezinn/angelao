...
<head>
    ...
    <!-- ARQUIVOS DE ESTILO CENTRALIZADOS -->
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="#">Encontrar Fotógrafos</a>
                        </li>
                        <li class="nav-item">
    ...
    <a class="nav-link d-flex align-items-center" href="#" data-bs-toggle="modal" data-bs-target="#userActionsModal">
        ...
        Olá, <?php echo isset($_SESSION['usuario_nome']) ? explode(' ', $_SESSION['usuario_nome'])[0] : 'Cliente'; ?>
    </a>
</li>
                </div>
            </div>
