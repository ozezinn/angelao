...
if (!isset($_SESSION['usuario_nome']) || $_SESSION['usuario_tipo'] !== 'professor') {
    echo "<script>alert('Acesso restrito à área do professor.');
    window.location.href='../index.php?action=logar';</script>";
    exit();
}
...
<body>
    ...
    <main class="container">
        <div class="welcome-box">
            <h1>Olá, Professor(a) <?php echo htmlspecialchars($nome); ?>!</h1>
