...
// $model = new UsuarioModel(); // <- LINHA ANTIGA COM ERRO
$model = new UsuarioModel($pdo); // <-- CORREÇÃO: Passa a conexão $pdo
...
<body>
    ...
    <main class="container admin-container">
        <header class="admin-header">
            ...
            <p class="lead text-muted">Olá, <strong><?= htmlspecialchars($nome_admin) ?></strong>! Gerencie os usuários
                da plataforma.</p>
        </header>
        ...
        <section class="admin-content">
            <ul class="nav nav-tabs" id="adminTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link <?= $aba_ativa === 'profissionais' ? 'active' : '' ?>"
                        id="profissionais-tab" data-bs-toggle="tab" data-bs-target="#profissionais" type="button"
                        role="tab" aria-controls="profissionais" aria-selected="true">
                        <i class="bi bi-briefcase-fill me-2"></i>Profissionais
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link <?= $aba_ativa === 'clientes' ? 'active' : '' ?>" id="clientes-tab"
                        data-bs-toggle="tab" data-bs-target="#clientes" type="button" role="tab"
                        aria-controls="clientes" aria-selected="false">
            ...
            <div class="tab-content" id="adminTabContent">
                ...
                <div class="tab-pane fade <?= $aba_ativa === 'profissionais' ? 'show active' : '' ?>" id="profissionais"
                    role="tabpanel" aria-labelledby="profissionais-tab">
                                            ...
                                            <?php foreach ($profissionais as $p): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="abc.php?action=editarUsuario&id=<?= $p['id_usuario'] ?>"
                ...
                <div class="tab-pane fade <?= $aba_ativa === 'clientes' ? 'show active' : '' ?>" id="clientes"
                                        ...
                                        <?php if (!empty($clientes)): ?>
                                            <?php foreach ($clientes as $c): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="abc.php?action=editarUsuario&id=<?= $c['id_usuario'] ?>"
                                                            class="btn btn-sm btn-outline-primary" title="Editar">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </a>
                                                        <a href="#" class="btn btn-sm btn-outline-danger" title="Excluir"
