<div class="modal fade" id="addPortfolioModal" tabindex="-1" aria-labelledby="addPortfolioModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="portfolioForm" action="abc.php?action=uploadFotoPortfolio" method="POST" enctype="multipart/form-data">

                <input type="hidden" name="id_item" id="portfolioItemId">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="servicoRelacionado" name="id_servico" required>
                            <?php
                            // PHP para popular as opções (permanece igual)
                    ...
                    <div class="mb-3" id="arquivoFotoContainer">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="portfolioSubmitButton">Adicionar Foto</button>
                </div>
            </form>
        </div>
    </div>
